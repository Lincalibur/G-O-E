...
def compare_and_find_matching(missing_list_path, tracking_folder_path, imei_folder_path, found_tracking_path, found_imei_path, not_found_path, missing_sheet_name='Missing', created_at_column='Created At'):
    # Load Missing List
